  ...
  return (
    <div>
      <div className="  flex flex-col  h-[365px] bg-black text-white">
        <div className="p-8 flex h-[350px] flex-col justify-between">
          <p className="pl-1">
            Images found on{""}
            <a
              className="p-1 hover:bg-slate-700 underline hover:underline-offset-2 transition duration-00 rounded-md"
